...
static struct tcmu_dev_attrib_attribute _backend##attr_##_name = \
		__CONFIGFS_EATTR_RO(_name, _backend##_name##_show);
...
static ssize_t tcmu_max_data_area_mb_show(struct se_dev_attrib *da, char *page)
{
	struct tcmu_dev *udev = TCMU_DEV(da->da_dev);
...
TB_DEV_ATTR_RO(tcmu_, max_data_area_mb);
...
static struct configfs_attribute *tcmu_attrib_attrs[] = {
	...
	&tcmu_attr_max_data_area_mb.attr,
